...
function initScene(){
	...
	FBObject3 = new FBObject({
    	...
    	vertexShader: "vs",
    	fragmentShader1: "fs",
    	fragmentShader2: "texFlowFs",
    	mainScene: mainScene,
    	extraTex: FBObject2.renderTargets[1]
	});
	FBObject3.uniforms = globalUniforms;
	FBObject3.init(w,h);

	FBObject1.addObject(FBObject1.x);
	FBObject2.addObject(FBObject2.x);
	FBObject3.addObject(FBObject3.x);
